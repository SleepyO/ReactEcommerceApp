...
const LoadAssets = async () => {
  const imageAssets = Asset.loadAsync([
    require("./src/assets/Images/banner1.jpeg"),
    require("./src/assets/Images/banner3.jpeg"),
    require("./src/assets/Images/banner4.jpeg"),
    require("./src/assets/Images/banner5.jpeg"),
    require("./src/assets/Images/banner6.jpeg"),
    require("./src/assets/Images/bg1.jpeg"),
    require("./src/assets/Images/bg2.jpeg"),
    require("./src/assets/Images/bg3.jpeg"),
    ...
    require("./src/assets/Images/slide1.jpeg"),
    require("./src/assets/Images/slide2.jpeg"),
    require("./src/assets/Images/slide3.jpeg"),
